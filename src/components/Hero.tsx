import { ArrowRight, Shield, Globe, FileText, MessageSquare, Plus, Heart } from "lucide-react";
import { useIsMobile } from "@/hooks/use-mobile";
import { motion } from "framer-motion";
import { Button } from "@/components/ui/button";
import britoniaLogo from '@/assets/britonia-logo.png';
import britoniaHero from '@/assets/britonia-hero.jpg';
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              ...
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6" variants={itemVariants}>
                Britonia Pharmacy Ltd - Your trusted partner for malaria drug distribution, trademark registration, and regulatory services across Africa. Based in Accra, Ghana.
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Malaria Drug Sales</h3>
            <p className="text-gray-600 text-xs md:text-sm">Authorized distribution of quality malaria treatment drugs to government agencies across West Africa.</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Trademark Registration</h3>
            <p className="text-gray-600 text-xs md:text-sm">Comprehensive trademark registration services including ARIPO and Madrid Protocol applications.</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Regulatory Services</h3>
            <p className="text-gray-600 text-xs md:text-sm">Expert regulatory compliance services for WAHO, AMA, WHO, and ECOWAS requirements.</p>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>;
